...
{{
var G__5612 = cljs.core.pop.call(null,v__$1);
v__$1 = G__5612;
continue;
}
} else
...
{var pred__5616 = cljs.core._EQ_;var expr__5617 = limit;if(cljs.core.truth_(pred__5616.call(null,1,expr__5617)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__5616.call(null,2,expr__5617)))
...
var G__5619 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__5620 = (limit__$1 - 1);
var G__5621 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__5619;
limit__$1 = G__5620;
parts = G__5621;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___5623 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___5623))
{var replacement_5624 = temp__4090__auto___5623;buffer.append([cljs.core.str(replacement_5624)].join(''));
} else
{buffer.append(ch);
}
{
